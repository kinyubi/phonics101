    ...
    <div id="tic-tac-toe">
      <div id="container">
        ...
        <div id="theboard">
          <table>
            <tr>
              <td id="s-1" class="square receptacle border__right border__bottom">-</td>
              <td id="s-2" class=" square receptacle border__right border__bottom">-</td>
              <td id="s-3" class=" square receptacle border__bottom">-</td>
            </tr>
            <tr>
              <td id="s-4" class=" square receptacle border__right border__bottom">-</td>
              <td id="s-5" class=" square receptacle border__right border__bottom">-</td>
              <td id="s-6" class=" square receptacle border__bottom">-</td>
            </tr>
            <tr>
              <td id="s-7" class=" square receptacle border__right">-</td>
              <td id="s-8" class=" square receptacle border__right">-</td>
              <td id="s-9" class=" square receptacle">-</td>
            </tr>
          </table>
        </div>
