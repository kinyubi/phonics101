...
*/
    ...
    class ChartConfig
    {
        private bool $useMultipleColor;
        private bool $showPointCaption;
        private bool $sortDataPoint;
         ...
         *
         * @param bool $showPointCaption Show caption on individual data points : boolean
         */
         ...
         *
         * @return bool Show caption on individual data points : boolean
         */
