...
*/
     ...
     */
    class Text {
        public int $HORIZONTAL_LEFT_ALIGN = 1;
        public int $HORIZONTAL_CENTER_ALIGN = 2;
        public int $HORIZONTAL_RIGHT_ALIGN = 4;
        public int $VERTICAL_TOP_ALIGN = 8;
        public int $VERTICAL_CENTER_ALIGN = 16;
        public int $VERTICAL_BOTTOM_ALIGN = 32;
